...
import { GroupMessagesResponse } from 'src/app/modules/communication/models/group.models';
...
export class MessagesEffects {
  ...
  loadMessages$ = createEffect(() => { return this.actions$.pipe(
